...
We have tested the five different methods for different values of the absolute and relative tolerances. The results are gathered in table \ref{tab:StepSize}
